...
# Copied from Oostenbrinck et al. (https://github.com/hansenniels/gromos_tutorial_livecoms/blob/master/tutorial_files/t_02/corrections/ASA/dGdsm/integrate.py)
...
gamW  = .007641 *10**(-18) # Here replaced by the value for TIP3P      
#charge, [e]
#QG    = float(netcharge)                      
#cut-off distance [m]
#cut    = float(cut) * 10**(-9)         
...
def main():
  ...
  rdf_file = readfile(rdf_filename)
  info_file = readfile(info_filename) # system.info 
